...
import no.sfi.mechatronics.fmi4j.jna.Fmi2Status
import no.sfi.mechatronics.fmi4j.jna.Fmi2Type
import no.sfi.mechatronics.fmi4j.modeldescription.*
...
abstract class Fmu<E : Fmi2LibraryWrapper<*>, T : ModelDescription> {
    ...
    private fun injectWrapperInVariables() {
        try {
            val f = VariableBase::class.java.getDeclaredField("_wrapper")
            f.isAccessible = true
