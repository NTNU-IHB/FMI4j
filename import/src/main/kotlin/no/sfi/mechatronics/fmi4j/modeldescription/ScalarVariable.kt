...
import no.sfi.mechatronics.fmi4j.jna.Fmi2LibraryWrapper
...
public class ScalarVariableImpl : IScalarVariable {
    ...
    override fun toString(): String {
        return "ScalarVariable2Impl(name='$name', declaredType='$declaredType', description='$description', causality=$causality, variability=$variability, initial=$initial)"
    }
...
abstract class VariableBase<E>(v : ScalarVariableImpl) : IScalarVariable by v, ScalarVariable<E> {
    ...
    private var _wrapper : Fmi2LibraryWrapper<*>? = null
