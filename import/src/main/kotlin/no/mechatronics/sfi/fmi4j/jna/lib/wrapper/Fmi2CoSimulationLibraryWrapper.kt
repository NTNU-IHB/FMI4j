...
import no.mechatronics.sfi.fmi4j.jna.lib.Fmi2CoSimulationLibrary
import no.mechatronics.sfi.fmi4j.jna.lib.StringByReference


class Fmi2CoSimulationLibraryWrapper(
        libraryFolder: String,
        libraryName: String
) : Fmi2LibraryWrapper<Fmi2CoSimulationLibrary>(libraryFolder, libraryName, Fmi2CoSimulationLibrary::class.java) {
